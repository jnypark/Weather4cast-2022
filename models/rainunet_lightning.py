...
from models.RainUNET import UNet as Base_UNET3D # 3_3_2 model selection
...
class UNet_Lightning(pl.LightningModule):
    def __init__(self, UNet_params: dict, params: dict,
        ...
        self.in_channels = len(params['sat_bands'])
        self.start_filts = params['init_filter_size']
        self.full_norm = params['full_norm']
        self.dropout_rate = params['dropout_rate']
        self.norm = params['normalization']
        self.n_blocks = params['n_blocks']
        self.up_mode = params['up_mode']
        self.merge_mode = params['merge_mode']
        self.batch_norm = params['batch_norm']
        self.attention = params['attention']
        self.activation = params['activation']
        self.dim = params['dim']
        self.conv_mode = params['conv_mode']
        self.center_crop=params['center_crop']
                                
        self.model = Base_UNET3D(in_channels=self.in_channels,
    ...
    def on_fit_start(self):
        ...
        self.logger.log_hyperparams(metric_placeholder)
    ...
    def training_step(self, batch, batch_idx, phase='train'):
        ...
        loss = self._compute_loss(y_hat, y, mask=mask)#.detach().cpu()
