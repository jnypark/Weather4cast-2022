...
class RainData(Dataset):
    def __init__(
        ...
        **kwargs
        ...
        if self.data_split == 'validation':
            self.regions = region_to_predict #['boxi_0076']
            self.years = year_to_predict #['2020']
        ...
        if (self.data_split == 'training') & (self.data_cleansing==True):
            ...
            # Load pickle file
            load_name = 'th100.0_rate1.pkl'        ## None for no pickle file to load. File name in AZ_remove_lists directory to load.
            ...
            if load_name == None:
                ...
                load_path = os.path.join(root_path, load_name)
